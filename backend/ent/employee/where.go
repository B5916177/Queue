...
// EmployeePhone applies equality check predicate on the "employee_phone" field. It's identical to EmployeePhoneEQ.
func EmployeePhone(v int) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldEmployeePhone), v))
	})
}
...
// EmployeePhoneEQ applies the EQ predicate on the "employee_phone" field.
func EmployeePhoneEQ(v int) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldEmployeePhone), v))
	})
}

// EmployeePhoneNEQ applies the NEQ predicate on the "employee_phone" field.
func EmployeePhoneNEQ(v int) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldEmployeePhone), v))
	})
}

// EmployeePhoneIn applies the In predicate on the "employee_phone" field.
func EmployeePhoneIn(vs ...int) predicate.Employee {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Employee(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldEmployeePhone), v...))
	})
}

// EmployeePhoneNotIn applies the NotIn predicate on the "employee_phone" field.
func EmployeePhoneNotIn(vs ...int) predicate.Employee {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
	return predicate.Employee(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldEmployeePhone), v...))
	})
}

// EmployeePhoneGT applies the GT predicate on the "employee_phone" field.
func EmployeePhoneGT(v int) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldEmployeePhone), v))
	})
}

// EmployeePhoneGTE applies the GTE predicate on the "employee_phone" field.
func EmployeePhoneGTE(v int) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldEmployeePhone), v))
	})
}

// EmployeePhoneLT applies the LT predicate on the "employee_phone" field.
func EmployeePhoneLT(v int) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldEmployeePhone), v))
	})
}

// EmployeePhoneLTE applies the LTE predicate on the "employee_phone" field.
func EmployeePhoneLTE(v int) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldEmployeePhone), v))
	})
}

// HasQueue applies the HasEdge predicate on the "queue" edge.
func HasQueue() predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
...
func HasQueueWith(preds ...predicate.Queue) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
