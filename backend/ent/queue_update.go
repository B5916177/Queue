...
func (qu *QueueUpdate) SetEmployeeID(id int) *QueueUpdate {
	qu.mutation.SetEmployeeID(id)
	return qu
}

// SetNillableEmployeeID sets the employee edge to Employee by id if the given value is not nil.
func (qu *QueueUpdate) SetNillableEmployeeID(id *int) *QueueUpdate {
	if id != nil {
		qu = qu.SetEmployeeID(*id)
	}
	return qu
}

// SetEmployee sets the employee edge to Employee.
func (qu *QueueUpdate) SetEmployee(e *Employee) *QueueUpdate {
	return qu.SetEmployeeID(e.ID)
}
...
func (qu *QueueUpdate) ClearEmployee() *QueueUpdate {
	qu.mutation.ClearEmployee()
	return qu
}
...
func (qu *QueueUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if qu.mutation.EmployeeCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   queue.EmployeeTable,
			Columns: []string{queue.EmployeeColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: &sqlgraph.FieldSpec{
					Type:   field.TypeInt,
	...
	if nodes := qu.mutation.EmployeeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   queue.EmployeeTable,
...
// SetEmployeeID sets the employee edge to Employee by id.
func (quo *QueueUpdateOne) SetEmployeeID(id int) *QueueUpdateOne {
	quo.mutation.SetEmployeeID(id)
	return quo
}

// SetNillableEmployeeID sets the employee edge to Employee by id if the given value is not nil.
func (quo *QueueUpdateOne) SetNillableEmployeeID(id *int) *QueueUpdateOne {
	if id != nil {
		quo = quo.SetEmployeeID(*id)
	}
	return quo
}

// SetEmployee sets the employee edge to Employee.
func (quo *QueueUpdateOne) SetEmployee(e *Employee) *QueueUpdateOne {
	return quo.SetEmployeeID(e.ID)
}
...
// ClearEmployee clears the employee edge to Employee.
func (quo *QueueUpdateOne) ClearEmployee() *QueueUpdateOne {
	quo.mutation.ClearEmployee()
	return quo
}
...
func (quo *QueueUpdateOne) sqlSave(ctx context.Context) (q *Queue, err error) {
	...
	if quo.mutation.EmployeeCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   queue.EmployeeTable,
	...
	if nodes := quo.mutation.EmployeeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   queue.EmployeeTable,
