...
func (qc *QueueCreate) SetEmployeeID(id int) *QueueCreate {
	qc.mutation.SetEmployeeID(id)
	return qc
}

// SetNillableEmployeeID sets the employee edge to Employee by id if the given value is not nil.
func (qc *QueueCreate) SetNillableEmployeeID(id *int) *QueueCreate {
	if id != nil {
		qc = qc.SetEmployeeID(*id)
	}
	return qc
}

// SetEmployee sets the employee edge to Employee.
func (qc *QueueCreate) SetEmployee(e *Employee) *QueueCreate {
	return qc.SetEmployeeID(e.ID)
}
...
func (qc *QueueCreate) createSpec() (*Queue, *sqlgraph.CreateSpec) {
	...
	if nodes := qc.mutation.EmployeeIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
